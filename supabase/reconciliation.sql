...
with expected(check_name, expected_value) as (values
  ...
  --   คู่ 9 สิงหาคม 2569 — เอ็ม เมธี (เริ่ม 13:55 · เมนู 120 นาที) กับ กอล์ฟฟี่
  --   (เริ่ม 15:00 · เมนู 90 นาที) ทั้งคู่บันทึกเก้าอี้ 3
  --
  -- ไม่ใช่การจองซ้อนจริง — ตามกติกาที่ทำหน้าร้านจริง เอ็ม เมธีลุกจากเก้าอี้ 3 ตอน 14:55
  -- ไปนอนต่อครึ่งหลังบนเตียงไทย กอล์ฟฟี่เริ่ม 15:00 จึงไม่ได้ชนกับใครเลย พนักงานทำถูกมาตลอด
