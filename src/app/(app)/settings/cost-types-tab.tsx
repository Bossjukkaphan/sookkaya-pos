...
// หมวดนี้เป็นตัวปนระหว่างค่ามือ (ผันแปร) กับเงินเดือนพนักงานประจำ (คงที่)
// กติกาเดิมแยกด้วยการเดาคำในชื่อรายการ ซึ่งไม่แม่นกับคำใหม่ๆ จึงต้องให้เจ้าของร้านตรวจเอง
const HR_PAYROLL_CATEGORY = "HR / payroll (เงินประกัน ค่ามือ เงินเดือน)"
