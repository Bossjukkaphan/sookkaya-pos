...
// DONUT_COLORS ต้องมาจาก lib ไม่ใช่จากไฟล์ component ที่เป็น "use client"
// (server import ค่าจากไฟล์ client จะได้ proxy ไม่ใช่ค่าจริง — สีจะหลุดเงียบๆ)
import { donutSlices, DONUT_COLORS } from "@/lib/chart"
import { DonutChart, type DonutSliceLink } from "@/components/charts/donut-chart"
