  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-3">
        ...
        {/* กราฟมาจาก v_monthly_pl ซึ่งเส้นกำไรเป็น "กำไรเงินสด" คนละสูตรกับตัวเลขเชิงบัญชีข้างบน
            — ต้องเขียนบอก ไม่งั้นคนอ่านจะนึกว่าเป็นตัวเดียวกันคนละช่วง
            แท่งล่าสุดคือเดือนปัจจุบันซึ่งยังไม่จบเดือน (page.tsx รวมเดือนนี้ไว้ใน last6 เสมอ)
            ห้ามเคลมว่า "เดือนเต็ม" เพราะไม่จริง ต้องบอกตรงๆ ว่ายังไม่จบ */}
        <p className="text-xs text-slate-500">
          กราฟ 6 เดือนล่าสุด (เดือนปัจจุบันยังไม่จบเดือน) — เส้นกำไรเป็นกำไรเงินสด คนละสูตรกับกำไรเชิงบัญชีข้างบน
        </p>
