        ...
        <div className="grid grid-cols-3 gap-2">
          {PAYMENT_METHODS.map((m) => (
            <Button
              ...
              // บิลที่มีบรรทัดแบ่งจ่ายแล้ว: ช่องทางจริงอยู่ที่บรรทัดชำระ (bill_payments) ไม่ใช่ปุ่มแถบนี้
              // ปุ่มแถบนี้มีค่าเดียว แทนภาพบิลแบ่งจ่ายหลายช่องทางไม่ได้ จึงล็อกทั้งแถบไว้กัน payment_method
              // เพี้ยนออกจากบรรทัด (ด่าน tracked_bill_method_mismatch เฝ้าอยู่) — จะเปลี่ยนช่องทางให้กดปุ่ม
              // "แก้ช่องทาง" ที่บรรทัดชำระแต่ละบรรทัดแทน
              disabled={
                payments.length > 0 ||
                (partialCreditActive &&
