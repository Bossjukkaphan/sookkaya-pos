...
- [ ] **Step 1: เขียนทั้ง 4 ไฟล์** (ตัวอย่าง `today` — อีก 3 หน้าใช้แพตเทิร์นเดียวกันแต่โครงต่างกัน: `queue` = บอร์ดไทม์ไลน์แถวต่อหมอนวด (แก้จากเดิมที่เขียนผิดว่ากริดการ์ด), `pos` = ฟอร์มช่องกรอกเรียงลง, `overview` = แถวการ์ดตัวเลข 3-4 ใบ + กราฟ)
