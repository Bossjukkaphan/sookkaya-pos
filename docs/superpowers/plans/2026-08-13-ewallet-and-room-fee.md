...
Expected: ทุกแถว `result = PASS` **ยกเว้นข้อเดียวที่ FAIL อยู่ก่อนเริ่มงานนี้แล้ว**:

> `bed_double_booked` — คาด 0 ได้ 1 · มีคิวสองรายการจองเตียงเดียวกันทับเวลากันเมื่อ 9 ส.ค. 2026
> เป็นข้อมูลหน้าร้านที่ต้องให้เจ้าของร้านตัดสินว่าใบไหนผิด ไม่เกี่ยวกับงานนี้ **ห้ามแก้เอง**

ถ้ามี FAIL ข้ออื่นนอกจากข้อนี้ = มีบั๊กจากงานนี้ ห้ามไปต่อ
